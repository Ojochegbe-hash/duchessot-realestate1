-- ==============================================================================
-- DUCHESSOT REAL ESTATE CMS - NON-DESTRUCTIVE EXISTING DATABASE MIGRATION
-- ==============================================================================
-- Target: EXISTING Supabase databases with active production data.
-- Safety: 100% NON-DESTRUCTIVE. Will NOT drop tables, truncate rows, or delete properties.
...
-- ==============================================================================
-- 2. PROPERTIES TABLE (Ensure Table & Missing Columns)
-- ==============================================================================
...
-- ==============================================================================
-- 3. SITE SETTINGS TABLE (Ensure Table & Default Row)
-- ==============================================================================
...
-- Preserve existing site settings data; insert default row only if none exists
...
-- ==============================================================================
-- 4. MESSAGES TABLE (Ensure Table, Columns & Synchronization)
-- ==============================================================================
...
-- Safely ensure read & is_read columns exist
DO $$
BEGIN
...
-- Trigger Function: Synchronize is_read and read flags for backwards compatibility
...
-- ==============================================================================
-- 5. TESTIMONIALS TABLE (Ensure Table)
-- ==============================================================================
...
-- ==============================================================================
-- 6. ROW LEVEL SECURITY (RLS) POLICIES RE-ALIGNMENT
-- ==============================================================================
...
-- STATUS NOTIFICATION
-- ==============================================================================
SELECT 'DUCHESSOT Existing Database Migration completed safely with zero data loss!' AS migration_status;
